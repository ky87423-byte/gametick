...
export const GAMES: GameInfo[] = [
  {
    ...
    servers: [
      ...
      { id: "27413", nameKo: "안타라스", nameEn: "Antharas" },
      { id: "27455", nameKo: "글루디오", nameEn: "Gludio" },
    ],
  },
  {
    slug: "aion2",
  ...
  },
  {
    ...
    servers: [
      ...
      { id: "27059", nameKo: "레지나", nameEn: "Regina" },
    ],
  },
  {
    slug: "lineage-m",
  ...
  },
  {
    ...
    servers: [
      ...
      { id: "27556", nameKo: "중국-6", nameEn: "China-6" },
    ],
  },
  {
    slug: "archeage-war",
  ...
  },
  {
    ...
    nameKo: "아스달연대기",
    nameEn: "Arthdal Chronicles",
    currency: "다이아",
    unitAmount: 1_000,
    unitLabelKo: "천",
    servers: [
      { id: "12898", nameKo: "통합 거래소", nameEn: "Unified Exchange" },
      { id: "10073", nameKo: "이나이신기", nameEn: "Inaisingi" },
      { id: "10074", nameKo: "아라문헤슬라", nameEn: "Aramun Heslla" },
      { id: "10076", nameKo: "윤슬", nameEn: "Yunseul" },
      { id: "10077", nameKo: "미하제", nameEn: "Mihaje" },
      { id: "13761", nameKo: "시아르", nameEn: "Siar" },
      { id: "24925", nameKo: "다르쿠스", nameEn: "Darkus" },
      { id: "24936", nameKo: "이브나", nameEn: "Ibna" },
      { id: "27217", nameKo: "Thoros", nameEn: "Thoros" },
      { id: "26289", nameKo: "Crabon", nameEn: "Crabon" },
      { id: "27302", nameKo: "레오", nameEn: "Leo" },
      { id: "27307", nameKo: "벨라", nameEn: "Vela" },
      { id: "27310", nameKo: "파보", nameEn: "Pavo" },
      { id: "27315", nameKo: "아라", nameEn: "Ara" },
      { id: "27450", nameKo: "오리온", nameEn: "Orion" },
      { id: "27451", nameKo: "리라", nameEn: "Lyra" },
      { id: "27474", nameKo: "뉴월드", nameEn: "New World" },
      { id: "21804", nameKo: "부스트", nameEn: "Boost" },
    ],
  },
  {
    slug: "zeus",
    ...
    unitAmount: 1_000,
    unitLabelKo: "천",
    chzzkKeyword: "제우스 오만의 신",
    liveMatch: ["제우스", "오만의 신", "Zeus"],
    liveExclude: ["제우스전자", "제우스 코인"],
    servers: [
      { id: "27916", nameKo: "아테나", nameEn: "Athena" },
      { id: "27938", nameKo: "아레스", nameEn: "Ares" },
      { id: "27939", nameKo: "제우스", nameEn: "Zeus" },
      { id: "27940", nameKo: "헤라", nameEn: "Hera" },
      { id: "27941", nameKo: "포세이돈", nameEn: "Poseidon" },
      { id: "27942", nameKo: "아폴론", nameEn: "Apollo" },
      { id: "27943", nameKo: "아르테미스", nameEn: "Artemis" },
      { id: "27944", nameKo: "아프로디테", nameEn: "Aphrodite" },
      { id: "27945", nameKo: "헤파이스토스", nameEn: "Hephaestus" },
      { id: "27946", nameKo: "헤르메스", nameEn: "Hermes" },
    ],
  },
  {
    slug: "kingdom2",
    ...
    unitLabelKo: "천",
    chzzkKeyword: "킹덤2",
    liveMatch: ["킹덤2", "킹덤 2", "타오르는 전장", "Kingdom2"],
    liveExclude: ["킹덤언더파이어", "킹덤컴"],
    servers: [
      { id: "28167", nameKo: "통합 거래소", nameEn: "Unified Exchange" },
      { id: "27683", nameKo: "아슈르스", nameEn: "Ashurs" },
      { id: "27788", nameKo: "프레지아", nameEn: "Frezia" },
      { id: "27789", nameKo: "서큐버스", nameEn: "Succubus" },
      { id: "27790", nameKo: "프로거스", nameEn: "Progus" },
      { id: "27791", nameKo: "로이자", nameEn: "Roiza" },
      { id: "27792", nameKo: "이에르긴", nameEn: "Iergin" },
      { id: "27793", nameKo: "앙그라스", nameEn: "Angras" },
      { id: "27794", nameKo: "쿠아르트", nameEn: "Quart" },
      { id: "27795", nameKo: "소피아", nameEn: "Sophia" },
      { id: "27796", nameKo: "헤르디온", nameEn: "Herdion" },
      { id: "27855", nameKo: "카밀", nameEn: "Camille" },
      { id: "27856", nameKo: "시엘", nameEn: "Ciel" },
      { id: "27857", nameKo: "나드리엘", nameEn: "Nadriel" },
      { id: "28050", nameKo: "잔느", nameEn: "Jeanne" },
      { id: "28051", nameKo: "아르마", nameEn: "Arma" },
    ],
  },
];
