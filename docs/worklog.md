...
**⑤ GSC 실적 CSV 실측 — 문제는 색인도 순위도 아닌 CTR** (사용자 내보내기, 최근 3개월)
...
- 🔑 **1페이지 16개 검색어 93노출에 클릭 0.** 최악 = "리니지2m 시세" **6.8위 59노출 0클릭**. 페이지로도 `/ko/lineage-2m` 9.3위 135노출 0클릭, `/ko/lineage-m` 11.9위 175노출 0클릭. **순위를 올릴 게 아니라 검색결과에서 눌리게 만들어야 하는 단계.**
